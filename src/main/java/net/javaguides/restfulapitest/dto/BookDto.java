package net.javaguides.restfulapitest.dto;
...
public class BookDto {
    ...
    public BookDto(String name, String genre, String publisher, double price, double rating, String description, int year_published, int copies_sold, Long authorId) {
        this.name = name;
        this.genre = genre;
